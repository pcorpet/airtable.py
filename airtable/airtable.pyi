...
_InceptRecordType = typing.TypeVar('_InceptRecordType', bound=Mapping[str, Any])
...
class Airtable(object):
    ...
    def create(self, table_name: str, data: _InceptRecordType) -> Record[_InceptRecordType]:
        ...

    def update(self, table_name: str, record_id: str, data: _InceptRecordType) \
            -> Record[_InceptRecordType]:
        ...

    def update_all(self, table_name: str, record_id: str, data: _InceptRecordType) \
            -> Record[_InceptRecordType]:
        ...
